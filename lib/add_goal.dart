                ...
                return <Widget>[
                  SliverAppBar(
                    ...
                    title: Container(
                        ...
                        child: const Text('Add your goal',style: TextStyle(
                            color: Colors.black,
                    ...
                    bottom: TabBar(
                      ...
                      tabs: [
                        const Tab(
                            child: Text('WHAT',style:
                            TextStyle(),),),
                        InkWell(
                            onTap: (){
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => const AddDeadline()),
                              );
                            },
                            child:
                            const Tab(child: Text('WHEN',style: TextStyle(),))),
                        InkWell(
                            onTap: (){
                              Navigator.push(
                                context,
                            ...
                            child:
                            const Tab(child: Text('HOW',style: TextStyle(),))),
                        InkWell(
                            onTap: (){
                              Navigator.push(
                                context,
                            ...
                            child:
                            const Tab(child: Text('WHY',style: TextStyle(),))),
                      ],
                    ),
                  ),
                ];
