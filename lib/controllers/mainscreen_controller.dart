...
class MainScreenController extends GetxController{
  ...
  Rx<TextStyle> selectedSectionStyle = const TextStyle(color: Colors.blue, fontWeight: FontWeight.w900).obs;
    Rx<TextStyle> whatStyle = TextStyle(
      color: Colors.black.withOpacity(0.5), fontWeight: FontWeight.w500).obs;
  ...
  void onInit() {
    super.onInit();
     headingText.value = 'Add your goal';
      whatStyle.value = const TextStyle(color: Colors.blue, fontWeight: FontWeight.w900);
      howStyle.value = TextStyle(color : Colors.black.withOpacity(0.5), fontWeight: FontWeight.w500);
       whenStyle.value = TextStyle(color : Colors.black.withOpacity(0.5), fontWeight: FontWeight.w500);
        whyStyle.value = TextStyle(color : Colors.black.withOpacity(0.5), fontWeight: FontWeight.w500);
  ...
  void switchHeadingText(String h,){
    if(h=='when'){
      headingText.value = 'Add a deadline'; 
      whenStyle.value = const TextStyle(color: Colors.blue, fontWeight: FontWeight.w900);
      whatStyle.value = TextStyle(color : Colors.black.withOpacity(0.5), fontWeight: FontWeight.w500);
       howStyle.value = TextStyle(color : Colors.black.withOpacity(0.5), fontWeight: FontWeight.w500);
        whyStyle.value = TextStyle(color : Colors.black.withOpacity(0.5), fontWeight: FontWeight.w500);
    }
    ...
    if(h=='how'){
      ...
      howStyle.value = const TextStyle(color: Colors.blue, fontWeight: FontWeight.w900);
      whatStyle.value = TextStyle(color : Colors.black.withOpacity(0.5), fontWeight: FontWeight.w500);
       whenStyle.value = TextStyle(color : Colors.black.withOpacity(0.5), fontWeight: FontWeight.w500);
        whyStyle.value = TextStyle(color : Colors.black.withOpacity(0.5), fontWeight: FontWeight.w500);
      ...
      whyStyle.value = const TextStyle(color: Colors.blue, fontWeight: FontWeight.w900);
      whatStyle.value = TextStyle(color : Colors.black.withOpacity(0.5), fontWeight: FontWeight.w500);
       whenStyle.value = TextStyle(color : Colors.black.withOpacity(0.5), fontWeight: FontWeight.w500);
        howStyle.value = TextStyle(color : Colors.black.withOpacity(0.5), fontWeight: FontWeight.w500);
